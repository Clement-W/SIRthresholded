...
## -----------------------------------------------------------------------------
res_STSIR = SIR_threshold_opt(Y=Y, X=X, H=10, n_lambda=300, thresholding="soft", graph=FALSE)
...
res_HTSIR = SIR_threshold_opt(Y=Y, X=X, H=10, n_lambda=300, thresholding="hard", graph=FALSE)
...
## -----------------------------------------------------------------------------
res_SIR_boot = SIR_threshold_bootstrap(Y,X,H=10,n_lambda=300,thresholding="hard", n_replications=30,k=2,graph = FALSE)
